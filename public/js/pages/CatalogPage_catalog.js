    ...
    <div class="product-card ${!product.inStock ? 'out-of-stock' : ''}" data-product-id="${product.id}" data-unit-price="${product.price}">
      ...
      <div class="product-info">
        ...
        <div class="product-footer">
          <div class="product-price" id="price-${product.id}" data-base-price="${product.price}">
...
function updatePriceDisplay(priceEl, unitPrice, quantity) {
    if (priceEl) {
...
function setupEventListeners() {
    ...
    document.getElementById('nation-filter')?.addEventListener('change', (e) => {
        currentFilters.nation = e.target.value;
        applyFilters();
    });
    ...
    document.getElementById('level-filter')?.addEventListener('change', (e) => {
        currentFilters.level = parseInt(e.target.value) || 0;
        applyFilters();
    });
    ...
    document.querySelectorAll('.product-card').forEach(card => {
        card.addEventListener('click', (e) => {
            ...
            if (target.closest('.qty-btn') || target.closest('.add-to-cart-btn'))
                return;
